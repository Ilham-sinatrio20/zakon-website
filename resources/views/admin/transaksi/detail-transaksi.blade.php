            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Jenis Meet</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="date" class="form-control" readonly id="jenis_meet" name="jenis_meet" value="{{ $trans->jenis_meet }}">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
