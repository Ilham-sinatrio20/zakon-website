...
(function(e, t, n, r) {
    ...
    e.expr[":"].uncached = function(t) {
        if (!e(t).is('img[src!=""]')) { return false }
        var n = new Image;
        n.src = t.src;
        return !n.complete
    };
    var o = {
        init: function(e, t) {
            ...
            if (n.options.singlePageDeeplinking && t === "singlePage") {
                n.url = location.href;
                if (n.url.slice(-1) == "#") { n.url = n.url.slice(0, -1) }
                r = n.cubeportfolio.blocksAvailable.find(n.options.singlePageDelegate).filter(function(e) { return n.url.split("#cbp=")[1] === this.getAttribute("href") })[0];
                if (r) {
        ...
        _createMarkup: function() {
            var t = this;
            t.wrap = e("<div/>", { "class": "cbp-popup-wrap cbp-popup-" + t.type, "data-action": t.type === "lightbox" ? "close" : "" }).on("click" + s, function(n) {
            ...
            if (t.cubeportfolio.browser === "ie8") { t.bg = e("<div/>", { "class": "cbp-popup-ie8bg", "data-action": t.type === "lightbox" ? "close" : "" }).appendTo(t.wrap) }
            ...
            t.prevButton = e("<button/>", { "class": "cbp-popup-prev", title: "Previous (Left arrow key)", type: "button", "data-action": "prev" }).appendTo(t.navigation);
            if (t.type === "singlePage") {
                if (t.options.singlePageShowCounter) { t.counter = e("<div/>", { "class": "cbp-popup-singlePage-counter" }).appendTo(t.navigation) }
                t.content.on("click" + s, t.options.singlePageDelegate, function(e) {
                    e.preventDefault();
                    var n, r = t.dataArray.length,
                        i = this.getAttribute("href");
                    for (n = 0; n < r; n++) { if (t.dataArray[n].url == i) { break } }
                    t.singlePageJumpTo(n - t.current)
                })
            }
            e(n).on("keydown" + s, function(e) { if (!t.isOpen) return; if (t.stopEvents) return; if (e.keyCode === 37) { t.prev() } else if (e.keyCode === 39) { t.next() } else if (e.keyCode === 27) { t.close() } })
        },
        ...
        openLightbox: function(r, i) {
            ...
            if (u === null) { throw new Error("HEI! Your clicked element doesn't have a href attribute.") }
            e.each(r.find(s.options.lightboxDelegate), function(t, n) {
                var r = n.getAttribute("href"),
                    i = r,
                    f = "isImage";
                if (e.inArray(r, a) === -1) {
                    if (u == r) { s.current = o } else if (!s.options.lightboxGallery) { return }
                    if (/youtube/i.test(r)) {
                        ...
                        if (r.indexOf("|") !== -1) { i = r.split("|") } else { i = r.split("%7C") }
                        f = "isSelfHosted"
                    }
        ...
        openSinglePage: function(r, i) {
            ...
            e("html").css({ overflow: "hidden", paddingRight: t.innerWidth - e(n).width() });
            s.wrap.scrollTop(0);
            if (e.isFunction(s.options.singlePageCallback)) { s.options.singlePageCallback.call(s, s.dataArray[s.current].url, s.dataArray[s.current].element) }
            s.wrap.show();
            ...
            if (s.cubeportfolio.browser === "ie8" || s.cubeportfolio.browser === "ie9") {
                setTimeout(function() { s.wrap.addClass("cbp-popup-singlePage-sticky") }, 1e3);
                if (s.options.singlePageStickyNavigation) {
            ...
            setTimeout(function() { s.wrap.addClass("cbp-popup-singlePage-open") }, 20);
            if (s.options.singlePageDeeplinking) { location.href = s.url + "#cbp=" + s.dataArray[s.current].url }
        },
        openSinglePageInline: function(n, r, i) {
            ...
            if (s.isOpen) { if (s.dataArray[s.current].url != r.getAttribute("href")) { s.cubeportfolio.singlePageInline.close("open", { blocks: n, currentBlock: r, fromOpen: true }) } else { s.close() } return }
            ...
            if (f === null) { throw new Error("HEI! Your clicked element doesn't have a href attribute.") }
            ...
            s.counterTotal = s.dataArray.length;
            if (s.cubeportfolio.blocksClone) { if (s.cubeportfolio.ulHidden === "clone") { s.wrap.prependTo(s.cubeportfolio.$ul) } else { s.wrap.prependTo(s.cubeportfolio.$ulClone) } } else { s.wrap.prependTo(s.cubeportfolio.$ul) }
            if (s.options.singlePageInlinePosition === "top") {
                ...
                if (c == h) { s.lastColumn = true } else { s.lastColumn = false }
                if (i) { if (s.lastColumn) { s.top = s.lastColumnHeight } } else {
            ...
            if (e.isFunction(s.options.singlePageInlineCallback)) { s.options.singlePageInlineCallback.call(s, s.dataArray[s.current].url, s.dataArray[s.current].element) }
        ...
        _resizeSinglePageInline: function(t) {
            ...
            if (t) { n.wrap.removeClass("cbp-popup-loading") }
            ...
            if (n.options.singlePageInlineInFocus) { e("body, html").animate({ scrollTop: n.wrap.offset().top - 150 }) }
        },
        updateSinglePage: function(e) {
            ...
            if (t.options.singlePageShowCounter) { t.counter.text(t.current + 1 + " of " + t.counterTotal) }
        ...
        _loadSinglePageInline: function() {
            ...
            if (o) { var f; while (f = a.exec(o)) { n.push({ src: f[2] }) } }
            t.wrap.find("*").each(function() {
                var t = e(this);
                if (t.is("img:uncached")) { n.push({ src: t.attr("src"), element: t[0] }) }
                o = t.css("backgroundImage");
                if (o) { var r; while (r = a.exec(o)) { n.push({ src: r[2], element: t[0] }) } }
            });
            var l = n.length,
                c = 0;
            if (l === 0) { t._resizeSinglePageInline(true) }
            var h = function() { c++; if (c == l) { t._resizeSinglePageInline(true) } };
            for (r = 0; r < l; r++) {
                i = new Image;
        ...
        updateSelfHostedVideo: function(e, t, n) {
            ...
            for (i = 0; i < e.length; i++) { if (/(\.mp4)/i.test(e[i])) { s += '<source src="' + e[i] + '" type="video/mp4">' } else if (/(\.ogg)|(\.ogv)/i.test(e[i])) { s += '<source src="' + e[i] + '" type="video/ogg">' } else if (/(\.webm)/i.test(e[i])) { s += '<source src="' + e[i] + '" type="video/webm">' } }
        ...
        singlePageJumpTo: function(t) {
            ...
            if (e.isFunction(n.options.singlePageCallback)) {
                ...
                if (n.options.singlePageDeeplinking) { location.href = n.url + "#cbp=" + n.dataArray[n.current].url }
            }
        },
        resetWrap: function() { var e = this; if (e.type === "singlePage" && e.options.singlePageDeeplinking) { location.href = e.url + "#" } },
        getIndex: function(e) {
            var t = this;
            e = e % t.counterTotal;
            if (e < 0) { e = t.counterTotal + e }
            return e
        },
        close: function(n, r) {
            var i = this;
            ...
            if (i.type === "singlePageInline") {
                if (n === "open") {
                    ...
                    if (i.cubeportfolio.browser === "ie8" || i.cubeportfolio.browser === "ie9") {
                        ...
                        if (n === "promise") { if (e.isFunction(r.callback)) { r.callback.call(i.cubeportfolio) } }
                    } else {
                    ...
                    if (i.options.singlePageInlineInFocus) { e("body, html").animate({ scrollTop: i.scrollTop }) }
                }
        ...
        preloadNearbyImages: function() {
            ...
            for (var s = t.length - 1; s >= 0; s--) {
                if (r.dataArray[t[s]].type === "isImage") {
                    ...
                    n = new Image;
                    if (e('<img src="' + i + '">').is("img:uncached")) { n.src = i }
                }
            }
        }
    };
    var u = {
        ...
        nextItem: function() { this.jumpTo(1) },
        prevItem: function() { this.jumpTo(-1) },
        ...
        getIndex: function(e) { e = e % this.$liLength; if (e < 0) { e = this.$liLength + e } return e }
    };
    var a = {
        _main: function(t, n, r) {
            ...
            i.defaultFilter = "*";
            i.registeredEvents = [];
            if (e.isFunction(r)) { i._registerEvent("initFinish", r, true) }
            ...
            if (i.options.displayType === "lazyLoading" || i.options.displayType === "fadeIn") { i.$ul.css({ opacity: 0 }) }
            if (i.options.displayType === "fadeInToTop") { i.$ul.css({ opacity: 0, marginTop: 30 }) }
            i._browserInfo();
            i._initCSSandEvents();
            i._prepareBlocks();
            if (i.options.displayType === "lazyLoading" || i.options.displayType === "sequentially" || i.options.displayType === "bottomToTop" || i.options.displayType === "fadeInToTop") { i._load() } else { i._beforeDisplay() }
        },
        _browserInfo: function() {
            var e = this,
                n = navigator.appVersion,
                r, i;
            if (n.indexOf("MSIE 8.") !== -1) { e.browser = "ie8" } else if (n.indexOf("MSIE 9.") !== -1) { e.browser = "ie9" } else if (n.indexOf("MSIE 10.") !== -1) { e.browser = "ie10" } else if (t.ActiveXObject || "ActiveXObject" in t) { e.browser = "ie11" } else if (/android/gi.test(n)) { e.browser = "android" } else if (/iphone|ipad|ipod/gi.test(n)) { e.browser = "ios" } else if (/chrome/gi.test(n)) { e.browser = "chrome" } else { e.browser = "" }
            if (e.browser) { e.$obj.addClass("cbp-" + e.browser) }
            ...
            if (e.supportCSSTransform) { e._cssHooks() }
        },
        _styleSupport: function(e) {
            var t, r, i, s = e.charAt(0).toUpperCase() + e.slice(1),
                o = ["Moz", "Webkit", "O", "ms"],
                u = n.createElement("div");
            if (e in u.style) { r = e } else { for (i = o.length - 1; i >= 0; i--) { t = o[i] + s; if (t in u.style) { r = t; break } } }
            u = null;
            return r
        },
        _cssHooks: function() {
            ...
            var t = this,
                n;
            if (t._has3d()) { n = { translate: function(e) { return "translate3d(" + e[0] + "px, " + e[1] + "px, 0) " }, scale: function(e) { return "scale3d(" + e + ", " + e + ", 1) " }, skew: function(e) { return "skew(" + e[0] + "deg, " + e[1] + "deg) " } } } else { n = { translate: function(e) { return "translate(" + e[0] + "px, " + e[1] + "px) " }, scale: function(e) { return "scale(" + e + ") " }, skew: function(e) { return "skew(" + e[0] + "deg, " + e[1] + "deg) " } } }
            ...
            e.cssHooks.scale = {
                ...
                get: function(t, n) { var r = e.data(t, "transformFn"); return r && r.scale ? r.scale : 1 }
            };
            ...
            e.cssHooks.skew = { set: function(e, t) { r(e, t, "skew") }, get: function(t, n) { var r = e.data(t, "transformFn"); return r && r.skew ? r.skew : [0, 0] } }
        },
        _has3d: function() {
        ...
        _prepareBlocks: function() {
            ...
            if (e.options.caption) { e._captionInit() }
        },
        ...
        _overlayBottomCaption: function() {
            var t = this;
            if (t.browser === "ie8" || t.browser === "ie9") {
                e(".cbp-caption").on("mouseenter" + s, function() { e(this).find(".cbp-caption-activeWrap").animate({ bottom: 0 }, "fast") }).on("mouseleave" + s, function(t) {
        ...
        _moveRightCaption: function() {
            var t = this;
            if (t.browser === "ie8" || t.browser === "ie9") {
                e(".cbp-caption").on("mouseenter" + s, function() { e(this).find(".cbp-caption-activeWrap").animate({ left: 0 }, "fast") }).on("mouseleave" + s, function() {
        ...
        _minimalCaption: function() { var e = this },
        _minimalCaptionDestroy: function() { var e = this },
        _fadeInCaption: function() {
            var t = this,
                n;
            if (t.browser === "ie8" || t.browser === "ie9") {
                n = t.browser === "ie9" ? 1 : .8;
                e(".cbp-caption").on("mouseenter" + s, function() { e(this).find(".cbp-caption-activeWrap").animate({ opacity: n }, "fast") }).on("mouseleave" + s, function() { e(this).find(".cbp-caption-activeWrap").animate({ opacity: 0 }, "fast") })
            }
        },
        ...
        _initCSSandEvents: function() {
            ...
            e(t).on("resize" + s, function() {
                ...
                i = setTimeout(function() {
                    if (n.browser === "ie8") { a = e(t).width(); if (u === r || u != a) { u = a } else { return } }
                    n.$obj.removeClass("cbp-no-transition cbp-appendItems-loading");
                    if (n.options.gridAdjustment === "responsive") { n._responsiveLayout() }
                    n._layout();
                    n._processStyle(n.transition);
                    n._resizeMainContainer(n.transition);
                    if (n.lightbox) { n.lightbox.resizeImage() }
                    if (n.singlePage) {
                    ...
                    if (n.singlePageInline && n.singlePageInline.isOpen) { n.singlePageInline.close() }
                }, 50)
            })
        },
        _load: function() {
            ...
            var l = n.length,
                c = 0;
            if (l === 0) { t._beforeDisplay() }
            var h = function() { c++; if (c == l) { t._beforeDisplay(); return false } };
            for (r = 0; r < l; r++) {
                i = new Image;
                e(i).on("load" + s + " error" + s, h);
                i.src = n[r].src
        ...
        _beforeDisplay: function() {
            ...
            if (e.options.animationType) {
                if (e["_" + e.options.animationType + "Init"]) { e["_" + e.options.animationType + "Init"]() }
                e.$obj.addClass("cbp-animation-" + e.options.animationType);
                e.localColumnWidth = e.blocks.eq(0).outerWidth() + e.options.gapVertical;
                if (e.options.defaultFilter === "" || e.options.defaultFilter === "*") { e._display() } else { e.filter(e.options.defaultFilter, function() { e._display() }, e) }
            }
        },
        _display: function() {
            var e = this,
                t, n;
            if (e.options.gridAdjustment === "responsive") { e._responsiveLayout() }
            e._layout();
            e._processStyle("css");
            e._resizeMainContainer("css");
            if (e.options.displayType === "lazyLoading" || e.options.displayType === "fadeIn") { e.$ul.animate({ opacity: 1 }, e.options.displayTypeSpeed) }
            if (e.options.displayType === "fadeInToTop") { e.$ul.animate({ opacity: 1, marginTop: 0 }, e.options.displayTypeSpeed) }
        ...
        _layout: function() {
            ...
            t.blocksAvailable.each(function(n, r) {
                var i = e(r),
                    ...
                    o = 0;
                s = Math.min(s, t.cols);
                if (t.singlePageInline && n >= t.singlePageInline.matrice[0] && n <= t.singlePageInline.matrice[1]) { o = t.singlePageInline.height }
                if (s === 1) { t._placeBlocks(i, t.colVert, o) } else {
                    var u = t.cols + 1 - s,
                        a = [],
                        f, l;
                    for (l = 0; l < u; l++) {
        ...
        _layoutReset: function() {
            ...
            t.colVert = [];
            e = t.cols;
            while (e--) { t.colVert.push(0) }
        },
        _responsiveLayout: function() {
            var t = this,
                n, r;
            if (!t.columnWidthCache) { t.columnWidthCache = t.localColumnWidth } else { t.localColumnWidth = t.columnWidthCache }
            ...
            if (r / t.localColumnWidth > .5) { t.localColumnWidth = t.localColumnWidth - (t.localColumnWidth - r) / (t.cols + 1) } else { t.localColumnWidth = t.localColumnWidth + r / t.cols }
            ...
            t.blocks.each(function(r, i) {
                ...
                if (!o) { o = e.data(this, "cbp-wxh", { width: s.outerWidth(), height: s.outerHeight() }) }
        ...
        _processStyle: function(e) {
            var t = this;
            for (var n = t.styleQueue.length - 1; n >= 0; n--) { t.styleQueue[n].$el[e](t.styleQueue[n].style) }
            t.styleQueue = []
        },
        _placeBlocks: function(e, t, n) {
            var r = this,
                ...
                s = 0,
                o, u, a, f, l, c;
            for (l = 0, c = t.length; l < c; l++) { if (t[l] === i) { s = l; break } }
            if (r.singlePageInline && n !== 0) { r.singlePageInline.top = i }
            i += n;
            ...
            f = r.cols + 1 - c;
            for (l = 0; l < f; l++) { r.colVert[s + l] = a }
        },
        _withCSS2: function(e, t) { return { left: e, top: t } },
        _withCSS3: function(e, t) { return { translate: [e, t] } },
        ...
        _fadeOutFilter: function(e, t, n) {
            ...
            if (e.length) { r.styleQueue.push({ $el: e, style: { opacity: 0 } }) }
            if (t.length) { r.styleQueue.push({ $el: t, style: { opacity: 1 } }) }
            r._layout();
            r._processStyle(r.transitionByFilter);
            r._resizeMainContainer(r.transition);
            setTimeout(function() { r._filterFinish() }, 400)
        },
        _quicksandFilter: function(e, t, n) {
            ...
            t.removeClass("cbp-item-hidden");
            r.blocksAvailable = r.blocks.filter(n);
            if (e.length) { r.styleQueue.push({ $el: e, style: { scale: .01, opacity: 0 } }) }
            if (t.length) { r.styleQueue.push({ $el: t, style: { scale: 1, opacity: 1 } }) }
            r._layout();
            r._processStyle(r.transitionByFilter);
            r._resizeMainContainer(r.transition);
            setTimeout(function() { r._filterFinish() }, 400)
        ...
        _flipOutFilter: function(e, t, n) {
            ...
            t.removeClass("cbp-item-hidden");
            r.blocksAvailable = r.blocks.filter(n);
            if (e.length) { if (r.browser === "ie8" || r.browser === "ie9") { r.styleQueue.push({ $el: e, style: { opacity: 0 } }) } else { e.find(".cbp-item-wrapper").removeClass("cbp-animation-flipOut-in").addClass("cbp-animation-flipOut-out") } }
            if (t.length) { if (r.browser === "ie8" || r.browser === "ie9") { r.styleQueue.push({ $el: t, style: { opacity: 1 } }) } else { t.find(".cbp-item-wrapper").removeClass("cbp-animation-flipOut-out").addClass("cbp-animation-flipOut-in") } }
            r._layout();
            r._processStyle(r.transitionByFilter);
            r._resizeMainContainer(r.transition);
            setTimeout(function() { r._filterFinish() }, 400)
        ...
        _flipBottomFilter: function(e, t, n) {
            ...
            t.removeClass("cbp-item-hidden");
            r.blocksAvailable = r.blocks.filter(n);
            if (e.length) { if (r.browser === "ie8" || r.browser === "ie9") { r.styleQueue.push({ $el: e, style: { opacity: 0 } }) } else { e.find(".cbp-item-wrapper").removeClass("cbp-animation-flipBottom-in").addClass("cbp-animation-flipBottom-out") } }
            if (t.length) { if (r.browser === "ie8" || r.browser === "ie9") { r.styleQueue.push({ $el: t, style: { opacity: 1 } }) } else { t.find(".cbp-item-wrapper").removeClass("cbp-animation-flipBottom-out").addClass("cbp-animation-flipBottom-in") } }
            r._layout();
            r._processStyle(r.transitionByFilter);
            r._resizeMainContainer(r.transition);
            setTimeout(function() { r._filterFinish() }, 400)
        ...
        _scaleSidesFilter: function(e, t, n) {
            ...
            t.removeClass("cbp-item-hidden");
            r.blocksAvailable = r.blocks.filter(n);
            if (e.length) { if (r.browser === "ie8" || r.browser === "ie9") { r.styleQueue.push({ $el: e, style: { opacity: 0 } }) } else { e.find(".cbp-item-wrapper").removeClass("cbp-animation-scaleSides-in").addClass("cbp-animation-scaleSides-out") } }
            if (t.length) { if (r.browser === "ie8" || r.browser === "ie9") { r.styleQueue.push({ $el: t, style: { opacity: 1 } }) } else { t.find(".cbp-item-wrapper").removeClass("cbp-animation-scaleSides-out").addClass("cbp-animation-scaleSides-in") } }
            r._layout();
            r._processStyle(r.transitionByFilter);
            r._resizeMainContainer(r.transition);
            setTimeout(function() { r._filterFinish() }, 400)
        ...
        _skewFilter: function(e, t, n) {
            ...
            t.removeClass("cbp-item-hidden");
            r.blocksAvailable = r.blocks.filter(n);
            if (e.length) { r.styleQueue.push({ $el: e, style: { skew: [50, 0], scale: .01, opacity: 0 } }) }
            if (t.length) { r.styleQueue.push({ $el: t, style: { skew: [0, 0], scale: 1, opacity: 1 } }) }
            r._layout();
            r._processStyle(r.transitionByFilter);
            r._resizeMainContainer(r.transition);
            setTimeout(function() { r._filterFinish() }, 400)
        },
        _sequentiallyInit: function() { this.transitionByFilter = "css" },
        _sequentiallyFilter: function(e, t, n) {
            ...
            if (r.browser === "ie8" || r.browser === "ie9") { s[r.transition]({ top: "-=30", opacity: 0 }, 300) } else { s[r.transition]({ top: -30, opacity: 0 }) }
            setTimeout(function() {
                if (n !== "*") {
                    t = t.filter(n);
                    e = r.blocks.not(".cbp-item-hidden").not(n).addClass("cbp-item-hidden")
                ...
                if (t.length) { t.css("display", "block") }
                r._layout();
                r._processStyle(r.transitionByFilter);
                r._resizeMainContainer(r.transition);
                if (r.browser === "ie8" || r.browser === "ie9") { r.blocksAvailable.css("top", "-=30") }
                var i = 0,
                    s;
                (function o() {
                    s = r.blocksAvailable.eq(i++);
                    if (s.length) {
                        if (r.browser === "ie8" || r.browser === "ie9") { s[r.transition]({ top: "+=30", opacity: 1 }) } else { s[r.transition]({ top: 0, opacity: 1 }) }
                        setTimeout(o, 130)
                    } else { setTimeout(function() { r._filterFinish() }, 600) }
                })()
            }, 600)
        },
        _fadeOutTopInit: function() { this.transitionByFilter = "css" },
        _fadeOutTopFilter: function(e, t, n) {
            var r = this;
            r.blocksAvailable = r.blocks.filter(n);
            if (r.browser === "ie8" || r.browser === "ie9") { r.$ul[r.transition]({ top: -30, opacity: 0 }, 350) } else { r.$ul[r.transition]({ top: -30, opacity: 0 }) }
            r.$obj.addClass("cbp-no-transition");
            setTimeout(function() {
                if (n !== "*") {
                    t = t.filter(n);
                ...
                t.removeClass("cbp-item-hidden");
                if (e.length) { e.css("opacity", 0) }
                if (t.length) { t.css("opacity", 1) }
                r._layout();
                r._processStyle(r.transitionByFilter);
                r._resizeMainContainer(r.transition);
                if (r.browser === "ie8" || r.browser === "ie9") { r.$ul[r.transition]({ top: 0, opacity: 1 }, 350) } else { r.$ul[r.transition]({ top: 0, opacity: 1 }) }
                setTimeout(function() { r._filterFinish() }, 400)
            }, 400)
        },
        _boxShadowInit: function() { var e = this; if (e.browser === "ie8" || e.browser === "ie9") { e.options.animationType = "fadeOut" } else { e.blocksAvailable.append('<div class="cbp-animation-boxShadowMask"></div>') } },
        ...
        _slideLeftFilter: function(e, t, n) {
            ...
            if (r.transition === "css") {
                ...
                if (f.length) { f.one(r.animationEnd, function() { r._filterFinish() }) } else { r._filterFinish() }
            } else {
                u.find(".cbp-item-wrapper").animate({ left: "-100%" }, 400, function() { r._filterFinish() });
        ...
        _slideDelayInit: function() { this._wrapperFilterInit() },
        _slideDelayFilter: function(e, t, n) { this._wrapperFilter(e, t, n, "slideDelay", true) },
        _3dflipInit: function() { this._wrapperFilterInit() },
        _3dflipFilter: function(e, t, n) { this._wrapperFilter(e, t, n, "3dflip", true) },
        _rotateSidesInit: function() { this._wrapperFilterInit() },
        _rotateSidesFilter: function(e, t, n) { this._wrapperFilter(e, t, n, "rotateSides", true) },
        _flipOutDelayInit: function() { this._wrapperFilterInit() },
        _flipOutDelayFilter: function(e, t, n) { this._wrapperFilter(e, t, n, "flipOutDelay", false) },
        _foldLeftInit: function() { this._wrapperFilterInit() },
        _foldLeftFilter: function(e, t, n) { this._wrapperFilter(e, t, n, "foldLeft", true) },
        _unfoldInit: function() { this._wrapperFilterInit() },
        _unfoldFilter: function(e, t, n) { this._wrapperFilter(e, t, n, "unfold", true) },
        _scaleDownInit: function() { this._wrapperFilterInit() },
        _scaleDownFilter: function(e, t, n) { this._wrapperFilter(e, t, n, "scaleDown", true) },
        _frontRowInit: function() { this._wrapperFilterInit() },
        _frontRowFilter: function(e, t, n) { this._wrapperFilter(e, t, n, "frontRow", true) },
        _rotateRoomInit: function() { this._wrapperFilterInit() },
        _rotateRoomFilter: function(e, t, n) { this._wrapperFilter(e, t, n, "rotateRoom", true) },
        ...
        _wrapperFilter: function(t, n, r, i, s) {
            ...
            if (o.transition === "css") {
                ...
                l.each(function(t, n) {
                    if (d <= p && s) { e(n).find(".cbp-item-wrapper").addClass("cbp-animation-" + i + "-fadeOut") } else { e(n).find(".cbp-item-wrapper").addClass("cbp-animation-" + i + "-out").css("animation-delay", p / 20 + "s") }
                    p++
                });
                h = l.find(".cbp-item-wrapper").first();
                if (h.length) { h.one(o.animationEnd, function() { o._filterFinish(); if (o.browser === "ie10" || o.browser === "ie11") { setTimeout(function() { e(".cbp-item-wrapper").removeClass("cbp-animation-" + i + "-in") }, 300) } }) } else { o._filterFinish(); if (o.browser === "ie10" || o.browser === "ie11") { setTimeout(function() { e(".cbp-item-wrapper").removeClass("cbp-animation-" + i + "-in") }, 300) } }
            } else {
                l.find(".cbp-item-wrapper").animate({ left: "-100%" }, 400, function() { o._filterFinish() });
        ...
        _triggerEvent: function(e) { var t = this; if (t.registeredEvents[e]) { for (var n = t.registeredEvents[e].length - 1; n >= 0; n--) { t.registeredEvents[e][n].func.call(t); if (t.registeredEvents[e][n].oneTime) { t.registeredEvents[e].splice(n, 1) } } } },
        init: function(t, n) {
            var r = e.data(this, "cubeportfolio");
            if (r) { throw new Error("cubeportfolio is already initialized. Please destroy it before initialize again!") }
            r = e.data(this, "cubeportfolio", Object.create(a));
            r._main(this, t, n)
        },
        destroy: function(n) {
            var r = e.data(this, "cubeportfolio");
            if (!r) { throw new Error("cubeportfolio is not initialized. Please initialize before calling destroy method!") }
            if (e.isFunction(n)) { r._registerEvent("destroyFinish", n, true) }
            ...
            if (r.$ulClone) { r.$ulClone.remove() }
            if (r.browser) { r.$obj.removeClass("cbp-" + r.browser) }
            e(t).off("resize" + s);
            if (r.lightbox) { r.lightbox.destroy() }
            if (r.singlePage) { r.singlePage.destroy() }
            if (r.singlePageInline) { r.singlePageInline.destroy() }
            r.blocks.removeClass("cbp-item-hidden").removeAttr("style");
            r.blocks.find(".cbp-item-wrapper").children().unwrap();
            if (r.options.caption) { r._captionDestroy() }
            if (r.options.animationType) {
                if (r.options.animationType === "boxShadow") { e(".cbp-animation-boxShadowMask").remove() }
        ...
        filter: function(t, n, r) {
            var i = r || e.data(this, "cubeportfolio"),
                s, o;
            if (!i) { throw new Error("cubeportfolio is not initialized. Please initialize before calling filter method!") }
            t = t === "*" || t === "" ? "*" : t;
            if (i.isAnimating || i.defaultFilter == t) { return }
            if (i.browser === "ie8" || i.browser === "ie9") { i.$obj.removeClass("cbp-no-transition cbp-appendItems-loading") } else {
                i.obj.classList.remove("cbp-no-transition");
                i.obj.classList.remove("cbp-appendItems-loading")
            }
            i.defaultFilter = t;
            i.isAnimating = true;
            if (e.isFunction(n)) { i._registerEvent("filterFinish", n, true) }
            s = i.blocks.filter(".cbp-item-hidden");
            o = [];
            if (i.singlePageInline && i.singlePageInline.isOpen) { i.singlePageInline.close("promise", { callback: function() { i["_" + i.options.animationType + "Filter"](o, s, t) } }) } else { i["_" + i.options.animationType + "Filter"](o, s, t) }
        },
        showCounter: function(t) {
            var n = e.data(this, "cubeportfolio");
            if (!n) { throw new Error("cubeportfolio is not initialized. Please initialize before calling showCounter method!") }
            n.elems = t;
        ...
        appendItems: function(t, n) {
            var r = this,
                ...
                s, o, u, f;
            if (!i) { throw new Error("cubeportfolio is not initialized. Please initialize before calling appendItems method!") }
            if (i.singlePageInline && i.singlePageInline.isOpen) { i.singlePageInline.close("promise", { callback: function() { a._addItems.call(r, t, n) } }) } else { a._addItems.call(r, t, n) }
        },
        _addItems: function(t, n) {
            var r = e.data(this, "cubeportfolio"),
                i, s, o, u;
            if (e.isFunction(n)) { r._registerEvent("appendItemsFinish", n, true) }
            ...
            if (r.options.gridAdjustment === "responsive") { r._responsiveLayout() }
            r._layout();
            r._processStyle(r.transitionByFilter);
            r._resizeMainContainer("animate");
            ...
            if (r.elems) { a.showCounter.call(this, r.elems) }
